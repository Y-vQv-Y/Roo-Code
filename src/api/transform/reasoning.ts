...
export const getRooReasoning = ({
	...
	// For ADTEC Code models that support reasoning effort, absence of a selection should be
	...
	// For ADTEC Code, "minimal" is treated as "none" for effort-based reasoning – we omit
