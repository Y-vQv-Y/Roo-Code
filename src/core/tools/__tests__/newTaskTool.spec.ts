...
describe("newTaskTool", () => {
	...
	describe("VSCode setting: newTaskRequireTodos", () => {
		...
		it("should check VSCode setting with Package.name configuration key", async () => {
			...
			expect(mockGetConfiguration).toHaveBeenCalledWith("adtec-code")
			expect(mockGet).toHaveBeenCalledWith("newTaskRequireTodos", false)
		})

		it("should use current Package.name value (adtec-code-nightly) when accessing VSCode configuration", async () => {
			...
			;(pkg.Package as any).name = "adtec-code-nightly"
			...
			expect(mockGetConfiguration).toHaveBeenCalledWith("adtec-code-nightly")
			expect(mockGet).toHaveBeenCalledWith("newTaskRequireTodos", false)
		})
	})
