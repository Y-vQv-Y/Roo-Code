...
describe("loadRuleFiles", () => {
	...
	it("should read and trim file content", async () => {
		// Simulate no .adtec/rules directory
	...
	it("should not combine content from multiple rule files when they exist", async () => {
		...
		readFileMock.mockImplementation((filePath: PathLike) => {
			if (filePath.toString().endsWith(".adtecrules")) {
	...
	it("should use .adtec/rules/ directory when it exists and has files", async () => {
		// Simulate .adtec/rules directory exists
		...
		readdirMock.mockResolvedValueOnce([
			{ name: "file1.txt", isFile: () => true, isSymbolicLink: () => false, parentPath: "/fake/path/.adtec/rules" },
			{ name: "file2.txt", isFile: () => true, isSymbolicLink: () => false, parentPath: "/fake/path/.adtec/rules" },
		] as any)
		...
		statMock.mockImplementation((path) => {
			...
			if (
				normalizedPath.includes("/fake/path/.adtec/rules/file1.txt") ||
				normalizedPath.includes("/fake/path/.adtec/rules/file2.txt")
			) {
		...
		readFileMock.mockImplementation((filePath: PathLike) => {
			...
			if (normalizedPath === "/fake/path/.adtec/rules/file1.txt") {
				return Promise.resolve("content of file1")
			}
			if (normalizedPath === "/fake/path/.adtec/rules/file2.txt") {
		...
		const expectedRelativePath1 = process.platform === "win32" ? ".adtec\\rules\\file1.txt" : ".adtec/rules/file1.txt"
		const expectedRelativePath2 = process.platform === "win32" ? ".adtec\\rules\\file2.txt" : ".adtec/rules/file2.txt"
		...
		const expectedRulesDir = process.platform === "win32" ? "\\fake\\path\\.adtec\\rules" : "/fake/path/.adtec/rules"
		const expectedFile1Path =
			process.platform === "win32" ? "\\fake\\path\\.adtec\\rules\\file1.txt" : "/fake/path/.adtec/rules/file1.txt"
		const expectedFile2Path =
			process.platform === "win32" ? "\\fake\\path\\.adtec\\rules\\file2.txt" : "/fake/path/.adtec/rules/file2.txt"
	...
	it("should filter out cache files from .adtec/rules/ directory", async () => {
		// Simulate .adtec/rules directory exists
		statMock.mockResolvedValueOnce({
			isDirectory: vi.fn().mockReturnValue(true),
		} as any)
		...
		readdirMock.mockResolvedValueOnce([
			{ name: "rule1.txt", isFile: () => true, isSymbolicLink: () => false, parentPath: "/fake/path/.adtec/rules" },
			{ name: ".DS_Store", isFile: () => true, isSymbolicLink: () => false, parentPath: "/fake/path/.adtec/rules" },
			{ name: "Thumbs.db", isFile: () => true, isSymbolicLink: () => false, parentPath: "/fake/path/.adtec/rules" },
			{ name: "rule2.md", isFile: () => true, isSymbolicLink: () => false, parentPath: "/fake/path/.adtec/rules" },
			{ name: "cache.log", isFile: () => true, isSymbolicLink: () => false, parentPath: "/fake/path/.adtec/rules" },
			{
				name: "backup.bak",
				isFile: () => true,
				isSymbolicLink: () => false,
				parentPath: "/fake/path/.adtec/rules",
			},
			{ name: "temp.tmp", isFile: () => true, isSymbolicLink: () => false, parentPath: "/fake/path/.adtec/rules" },
			{
				name: "script.pyc",
				isFile: () => true,
				isSymbolicLink: () => false,
		...
		readFileMock.mockImplementation((filePath: PathLike) => {
			...
			if (normalizedPath === "/fake/path/.adtec/rules/rule1.txt") {
				return Promise.resolve("rule 1 content")
			}
			if (normalizedPath === "/fake/path/.adtec/rules/rule2.md") {
			...
			if (normalizedPath === "/fake/path/.adtec/rules/.DS_Store") {
				return Promise.resolve("DS_STORE_BINARY_CONTENT")
			}
			if (normalizedPath === "/fake/path/.adtec/rules/Thumbs.db") {
				return Promise.resolve("THUMBS_DB_CONTENT")
			}
			if (normalizedPath === "/fake/path/.adtec/rules/backup.bak") {
				return Promise.resolve("BACKUP_CONTENT")
			}
			if (normalizedPath === "/fake/path/.adtec/rules/cache.log") {
				return Promise.resolve("LOG_CONTENT")
			}
			if (normalizedPath === "/fake/path/.adtec/rules/temp.tmp") {
				return Promise.resolve("TEMP_CONTENT")
			}
			if (normalizedPath === "/fake/path/.adtec/rules/script.pyc") {
		...
		const expectedCacheFiles = [
			"/fake/path/.adtec/rules/.DS_Store",
			"/fake/path/.adtec/rules/Thumbs.db",
			"/fake/path/.adtec/rules/backup.bak",
			"/fake/path/.adtec/rules/cache.log",
			"/fake/path/.adtec/rules/temp.tmp",
			"/fake/path/.adtec/rules/script.pyc",
		]
	...
	it("should fall back to .adtecrules when .adtec/rules/ is empty", async () => {
		// Simulate .adtec/rules directory exists
		statMock.mockResolvedValueOnce({
			isDirectory: vi.fn().mockReturnValue(true),
		} as any)
	...
	it("should read files from nested subdirectories in .adtec/rules/", async () => {
		// Simulate .adtec/rules directory exists
		statMock.mockResolvedValueOnce({
			isDirectory: vi.fn().mockReturnValue(true),
		} as any)
		...
		readdirMock.mockResolvedValueOnce([
			...
			},
			{
				...
				isSymbolicLink: () => false,
				isDirectory: () => false,
				parentPath: "/fake/path/.adtec/rules/subdir",
			},
			{
				name: "nested2.txt",
				isFile: () => true,
				isSymbolicLink: () => false,
				isDirectory: () => false,
				parentPath: "/fake/path/.adtec/rules/subdir/subdir2",
			},
		] as any)
		...
		readFileMock.mockImplementation((filePath: PathLike) => {
			...
			// Handle both Unix and Windows path separators
			const normalizedPath = pathStr.replace(/\\/g, "/")
			if (normalizedPath === "/fake/path/.adtec/rules/root.txt") {
				return Promise.resolve("root file content")
			}
			if (normalizedPath === "/fake/path/.adtec/rules/subdir/nested1.txt") {
				return Promise.resolve("nested file 1 content")
			}
			if (normalizedPath === "/fake/path/.adtec/rules/subdir/subdir2/nested2.txt") {
		...
		const expectedRelativeRootPath = process.platform === "win32" ? ".adtec\\rules\\root.txt" : ".adtec/rules/root.txt"
		const expectedRelativeNested1Path =
			process.platform === "win32" ? ".adtec\\rules\\subdir\\nested1.txt" : ".adtec/rules/subdir/nested1.txt"
		const expectedRelativeNested2Path =
			process.platform === "win32"
				? ".adtec\\rules\\subdir\\subdir2\\nested2.txt"
				: ".adtec/rules/subdir/subdir2/nested2.txt"
		...
		const expectedRootPath2 =
			process.platform === "win32" ? "\\fake\\path\\.adtec\\rules\\root.txt" : "/fake/path/.adtec/rules/root.txt"
		const expectedNested1Path2 =
			process.platform === "win32"
				? "\\fake\\path\\.adtec\\rules\\subdir\\nested1.txt"
				: "/fake/path/.adtec/rules/subdir/nested1.txt"
		const expectedNested2Path2 =
			process.platform === "win32"
				? "\\fake\\path\\.adtec\\rules\\subdir\\subdir2\\nested2.txt"
				: "/fake/path/.adtec/rules/subdir/subdir2/nested2.txt"
...
describe("addCustomInstructions", () => {
	...
	it("should combine all instruction types when provided", async () => {
		// Simulate no .adtec/rules-test-mode directory
		statMock.mockRejectedValueOnce({ code: "ENOENT" })
		...
		expect(result).toContain("Rules from .adtecrules-test-mode:\nmode specific rules")
	})
	...
	it("should include AGENTS.md content along with other rules", async () => {
		...
		readFileMock.mockImplementation((filePath: PathLike) => {
			...
			if (pathStr.endsWith(".adtecrules")) {
				return Promise.resolve("ADTEC Code rules content")
			}
			return Promise.reject({ code: "ENOENT" })
		})
		...
		// Should contain both AGENTS.md and .adtecrules content
		expect(result).toContain("# Agent Rules Standard (AGENTS.md):")
		expect(result).toContain("Agent rules content")
		expect(result).toContain("# Rules from .adtecrules:")
		expect(result).toContain("ADTEC Code rules content")
	})
	...
	it("should use .adtec/rules-test-mode/ directory when it exists and has files", async () => {
		// Simulate .adtec/rules-test-mode directory exists
		statMock.mockResolvedValueOnce({
			isDirectory: vi.fn().mockReturnValue(true),
		} as any)
		...
		readdirMock.mockResolvedValueOnce([
			{
				...
				isFile: () => true,
				isSymbolicLink: () => false,
				parentPath: "/fake/path/.adtec/rules-test-mode",
			},
			{
				name: "rule2.txt",
				isFile: () => true,
		...
		statMock.mockImplementation((path) => {
			...
			const normalizedPath = path.toString().replace(/\\/g, "/")
			if (
				normalizedPath.includes("/fake/path/.adtec/rules-test-mode/rule1.txt") ||
				normalizedPath.includes("/fake/path/.adtec/rules-test-mode/rule2.txt")
			) {
				return Promise.resolve({
					isFile: vi.fn().mockReturnValue(true),
				}) as any
		...
		readFileMock.mockImplementation((filePath: PathLike) => {
			...
			// Handle both Unix and Windows path separators
			const normalizedPath = pathStr.replace(/\\/g, "/")
			if (normalizedPath === "/fake/path/.adtec/rules-test-mode/rule1.txt") {
				return Promise.resolve("mode specific rule 1")
			}
			if (normalizedPath === "/fake/path/.adtec/rules-test-mode/rule2.txt") {
		...
		const expectedRelativeRule1Path =
			process.platform === "win32" ? ".adtec\\rules-test-mode\\rule1.txt" : ".adtec/rules-test-mode/rule1.txt"
		const expectedRelativeRule2Path =
			process.platform === "win32" ? ".adtec\\rules-test-mode\\rule2.txt" : ".adtec/rules-test-mode/rule2.txt"
		...
		const expectedAbsTestModeDir =
			process.platform === "win32" ? "\\fake\\path\\.adtec\\rules-test-mode" : "/fake/path/.adtec/rules-test-mode"
		const expectedAbsRule1Path =
			process.platform === "win32"
				? "\\fake\\path\\.adtec\\rules-test-mode\\rule1.txt"
				: "/fake/path/.adtec/rules-test-mode/rule1.txt"
		const expectedAbsRule2Path =
			process.platform === "win32"
				? "\\fake\\path\\.adtec\\rules-test-mode\\rule2.txt"
				: "/fake/path/.adtec/rules-test-mode/rule2.txt"
	...
	it("should fall back to .adtecrules-test-mode when .adtec/rules-test-mode/ does not exist", async () => {
		// Simulate .adtec/rules-test-mode directory does not exist
		statMock.mockRejectedValueOnce({ code: "ENOENT" })

		// Simulate .adtecrules-test-mode exists
		readFileMock.mockImplementation((filePath: PathLike) => {
			if (filePath.toString().includes(".adtecrules-test-mode")) {
	...
	it("should fall back to .clinerules-test-mode when .adtec/rules-test-mode/ and .adtecrules-test-mode do not exist", async () => {
		// Simulate .adtec/rules-test-mode directory does not exist
		statMock.mockRejectedValueOnce({ code: "ENOENT" })
	...
	it("should correctly format content from directories when using .adtec/rules-test-mode/", async () => {
		...
		readdirMock.mockResolvedValueOnce([
			{ name: "rule1.txt", isFile: () => true, parentPath: "/fake/path/.adtec/rules-test-mode" },
		] as any)
		readFileMock.mockReset()
...
describe("Rules directory reading", () => {
	it.skipIf(process.platform === "win32")("should follow symbolic links in the rules directory", async () => {
		...
		readdirMock
			...
			.mockResolvedValueOnce([
				{ name: "subdir_link.txt", isFile: () => true, parentPath: "/fake/path/.adtec/rules/symlink-target-dir" },
			] as any)
		...
		statMock.mockImplementation((path: string) => {
			// For directory check
			if (path === "/fake/path/.adtec/rules" || path.endsWith("dir")) {
				return Promise.resolve({
					isDirectory: vi.fn().mockReturnValue(true),
					isFile: vi.fn().mockReturnValue(false),
				} as any)
		...
		readFileMock.mockImplementation((filePath: PathLike) => {
			...
			// Handle both Unix and Windows path separators
			const normalizedPath = pathStr.replace(/\\/g, "/")
			if (normalizedPath === "/fake/path/.adtec/rules/regular.txt") {
				return Promise.resolve("regular file content")
			}
			if (normalizedPath === "/fake/path/.adtec/symlink-target.txt") {
				return Promise.resolve("symlink target content")
			}
			if (normalizedPath === "/fake/path/.adtec/rules/symlink-target-dir/subdir_link.txt") {
				return Promise.resolve("regular file content under symlink target dir")
			}
			if (normalizedPath === "/fake/path/.adtec/nested-symlink-target.txt") {
		...
		const expectedRelativeRegularPath =
			process.platform === "win32" ? ".adtec\\rules\\regular.txt" : ".adtec/rules/regular.txt"
		const expectedRelativeSymlinkPath =
			process.platform === "win32" ? ".adtec\\symlink-target.txt" : ".adtec/symlink-target.txt"
		const expectedRelativeSubdirPath =
			process.platform === "win32"
				? ".adtec\\rules\\symlink-target-dir\\subdir_link.txt"
				: ".adtec/rules/symlink-target-dir/subdir_link.txt"
		const expectedRelativeNestedPath =
			process.platform === "win32" ? ".adtec\\nested-symlink-target.txt" : ".adtec/nested-symlink-target.txt"
		...
		expect(readlinkMock).toHaveBeenCalledWith("/fake/path/.adtec/rules/link.txt")
		expect(readlinkMock).toHaveBeenCalledWith("/fake/path/.adtec/rules/link_dir")

		// Verify both files were read
		expect(readFileMock).toHaveBeenCalledWith("/fake/path/.adtec/rules/regular.txt", "utf-8")
		expect(readFileMock).toHaveBeenCalledWith("/fake/path/.adtec/symlink-target.txt", "utf-8")
		expect(readFileMock).toHaveBeenCalledWith("/fake/path/.adtec/rules/symlink-target-dir/subdir_link.txt", "utf-8")
		expect(readFileMock).toHaveBeenCalledWith("/fake/path/.adtec/nested-symlink-target.txt", "utf-8")
	})
	beforeEach(() => {
		vi.clearAllMocks()
	})
	...
	it.skipIf(process.platform === "win32")("should correctly format multiple files from directory", async () => {
		...
		// Simulate listing files
		readdirMock.mockResolvedValueOnce([
			{ name: "file1.txt", isFile: () => true, parentPath: "/fake/path/.adtec/rules" },
			{ name: "file2.txt", isFile: () => true, parentPath: "/fake/path/.adtec/rules" },
			{ name: "file3.txt", isFile: () => true, parentPath: "/fake/path/.adtec/rules" },
		] as any)
		...
		statMock.mockImplementation((path) => {
			...
			const normalizedPath = path.toString().replace(/\\/g, "/")
			expect([
				"/fake/path/.adtec/rules/file1.txt",
				"/fake/path/.adtec/rules/file2.txt",
				"/fake/path/.adtec/rules/file3.txt",
		...
		readFileMock.mockImplementation((filePath: PathLike) => {
			...
			if (normalizedPath === "/fake/path/.adtec/rules/file3.txt") {
		...
		const expectedRelativeFile1Path =
			process.platform === "win32" ? ".adtec\\rules\\file1.txt" : ".adtec/rules/file1.txt"
		const expectedRelativeFile2Path =
			process.platform === "win32" ? ".adtec\\rules\\file2.txt" : ".adtec/rules/file2.txt"
		const expectedRelativeFile3Path =
			process.platform === "win32" ? ".adtec\\rules\\file3.txt" : ".adtec/rules/file3.txt"
	...
	it("should return files in alphabetical order by filename", async () => {
		...
		readdirMock.mockResolvedValueOnce([
			{ name: "zebra.txt", isFile: () => true, parentPath: "/fake/path/.adtec/rules" },
			{ name: "alpha.txt", isFile: () => true, parentPath: "/fake/path/.adtec/rules" },
			{ name: "Beta.txt", isFile: () => true, parentPath: "/fake/path/.adtec/rules" }, // Test case-insensitive sorting
		] as any)
		...
		readFileMock.mockImplementation((filePath: PathLike) => {
			const pathStr = filePath.toString()
			const normalizedPath = pathStr.replace(/\\/g, "/")
			if (normalizedPath === "/fake/path/.adtec/rules/zebra.txt") {
				return Promise.resolve("zebra content")
			}
			if (normalizedPath === "/fake/path/.adtec/rules/alpha.txt") {
				return Promise.resolve("alpha content")
			}
			if (normalizedPath === "/fake/path/.adtec/rules/Beta.txt") {
		...
		const expectedRelativeAlphaPath =
			process.platform === "win32" ? ".adtec\\rules\\alpha.txt" : ".adtec/rules/alpha.txt"
		const expectedRelativeBetaPath = process.platform === "win32" ? ".adtec\\rules\\Beta.txt" : ".adtec/rules/Beta.txt"
		const expectedRelativeZebraPath =
			process.platform === "win32" ? ".adtec\\rules\\zebra.txt" : ".adtec/rules/zebra.txt"
	...
	it("should sort symlinks by their symlink names, not target names", async () => {
		...
		// First call: check if .adtec/rules directory exists
		statMock.mockResolvedValueOnce({
			isDirectory: vi.fn().mockReturnValue(true),
		} as any)
