...
vi.mock("fs/promises")
vi.mock("../roo-config", () => ({
	getGlobalRooDirectory: vi.fn(() => "/mock/global/.adtec"),
	getProjectRooDirectoryForCwd: vi.fn(() => "/mock/project/.adtec"),
}))
...
\`\`\``
			...
			expect(result).toEqual({
				...
				source: "project",
				filePath: path.join("/test/cwd", ".adtec", "commands", "setup.md"),
				description: "Sets up the development environment",
...
Global setup instructions.`
			...
			expect(result).toEqual({
				...
				source: "global",
				filePath: expect.stringContaining(path.join(".adtec", "commands", "setup.md")),
				description: "Global setup command",
				argumentHint: undefined,
				mode: undefined,
			})
	...
	describe("argument-hint functionality", () => {
		it("should load command with argument-hint from frontmatter", async () => {
			const commandContent = `---
description: Create a new release of the ADTEC Code extension
...
Create a new release.`
			...
			expect(result).toEqual({
				...
				source: "project",
				filePath: path.join("/test/cwd", ".adtec", "commands", "release.md"),
				description: "Create a new release of the ADTEC Code extension",
...
Deploy the application.`
			...
			expect(result).toEqual({
				...
				source: "project",
				filePath: path.join("/test/cwd", ".adtec", "commands", "deploy.md"),
				description: "Deploy application to environment",
...
Start debugging.`
			...
			expect(result).toEqual({
				...
				source: "project",
				filePath: path.join("/test/cwd", ".adtec", "commands", "debug-app.md"),
				description: "Debug the application",
				argumentHint: undefined,
				mode: "debug",
			})
