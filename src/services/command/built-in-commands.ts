...
<initialization>
  ...
  <todo_list_creation>
    ...
    1. Check for existing AGENTS.md files
       ...
       - .adtec/rules-code/AGENTS.md (relative to project root)
       - .adtec/rules-debug/AGENTS.md (relative to project root)
       - .adtec/rules-ask/AGENTS.md (relative to project root)
       - .adtec/rules-architect/AGENTS.md (relative to project root)
       ...
       - .cursorrules, CLAUDE.md, .adtecrules
    ...
    8. Compile/Update AGENTS.md files
       ...
       - Create mode-specific files in .adtec/rules-*/ directories (IN PROJECT ROOT)
...
<analysis_workflow>
  ...
  1. **Discovery Phase**:
     ...
     IMPORTANT: The .adtec folder should be created in the PROJECT ROOT, not system root!
...
<output_structure>
  ...
  <mode_specific_files>
    ...
    - .adtec/rules-code/AGENTS.md (create .adtec in project root, not system root!)
    - .adtec/rules-debug/AGENTS.md (relative to project root)
    - .adtec/rules-ask/AGENTS.md (relative to project root)
    - .adtec/rules-architect/AGENTS.md (relative to project root)
    
    IMPORTANT: The .adtec directory must be created in the current project/workspace root directory,
    ...
    ├── .adtec/                        # IN PROJECT ROOT, NOT SYSTEM ROOT!
    │   ├── rules-code/
    ...
    .adtec/rules-code/AGENTS.md - ONLY non-obvious coding rules discovered by reading files:
    ...
    .adtec/rules-debug/AGENTS.md - ONLY non-obvious debugging discoveries:
    ...
    .adtec/rules-ask/AGENTS.md - ONLY non-obvious documentation context:
    ...
    .adtec/rules-architect/AGENTS.md - ONLY non-obvious architectural constraints:
