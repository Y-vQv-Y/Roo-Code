 ...
 *
 * This writes logs to ~/.adtec/cli-debug.log, avoiding stdout/stderr
...
const DEBUG_LOG_PATH = path.join(os.homedir(), ".adtec", "cli-debug.log")
 ...
 * Writes timestamped entries to ~/.adtec/cli-debug.log
