...
description: Use Fireworks AI with ADTEC Code to access state-of-the-art open-source and proprietary AI models like Kimi, Qwen, and DeepSeek on a high-performance platform with large context windows up to 256K tokens.
keywords:
    - fireworks ai
    - fireworks
    - kimi models
...
# Using Fireworks AI With ADTEC Code
...
3. **Create a Key:** Click "Create API key" and give your key a descriptive name (e.g., "ADTEC Code").
...
ADTEC Code supports all models available through Fireworks AI's platform.
