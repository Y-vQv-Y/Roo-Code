---
description: Configure OpenRouter in ADTEC Code to access 100+ language models from various providers through a single API with automatic model discovery.
keywords:
    - ADTEC Code
    - openrouter
    - ai provider
...
# Using OpenRouter With ADTEC Code
...
ADTEC Code automatically fetches all available models from OpenRouter's API (100+ models from various providers).
...
- **Bring Your Own Key (BYOK):** If you use your own key for the underlying service, OpenRouter charges 5% of what it normally would. ADTEC Code automatically adjusts the cost calculation to reflect this.
