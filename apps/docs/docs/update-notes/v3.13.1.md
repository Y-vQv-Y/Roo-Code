---
description: ADTEC Code 3.13.1 adds Gemini 2.5 Flash thinking mode support, improves auto-approval toggle UI, and fixes Windows file path issues.
keywords:
    - ADTEC Code
    - v3.13.1
    - release notes
...
# ADTEC Code 3.13.1 Release Notes (2025-04-18)
