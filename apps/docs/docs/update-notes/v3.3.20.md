...
# ADTEC Code 3.3.20 Release Notes (2025-02-14)
...
- **Project-Level Custom Modes:** Added support for defining project-specific custom modes in a `.adtecmodes` file within the workspace.
