---
description: ADTEC Code 3.11.7 improves file tool context formatting, enhances zh-TW and zh-CN localization, and adds reference counting for McpHub.
keywords:
    - ADTEC Code
    - v3.11.7
    - release notes
...
# ADTEC Code 3.11.7 Release Notes (2025-04-04)
