---
description: ADTEC Code 2.2.33 introduces Enhance Prompt feature for OpenRouter models and adds model listing for OpenAI-compatible providers.
keywords:
    - ADTEC Code
    - v2.2.33
    - release notes
...
# ADTEC Code 2.2.33 Release Notes
