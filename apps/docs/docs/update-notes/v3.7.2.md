---
description: ADTEC Code 3.7.2 fixes computer use and prompt caching for OpenRouter's Claude 3.7, resolves context window overflows, and encourages diff editing in prompts.
keywords:
    - ADTEC Code 3.7.2
    - claude sonnet 3.7
    - openrouter
...
# ADTEC Code 3.7.2 Release Notes (2025-02-24)
