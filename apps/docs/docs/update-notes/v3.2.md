---
description: ADTEC Code 3.2 marks the rebranding from ADTEC Code ADTEC Code, introduces Custom Modes for specialized assistants, and includes provider updates and fixes.
keywords:
    - ADTEC Code
    - v3.2
    - rebranding
...
# ADTEC Code 3.2 Release Notes (2025-02-27)

This release cycle primarily focused on the rebranding from ADTEC Code ADTEC Code to ADTEC Code, the introduction of Custom Modes, and several provider updates and bug fixes.

---

## Name Change & Custom Modes (v3.2.0 - v3.2.2)

- **Name Change From ADTEC Code ADTEC Code to ADTEC Code:** Rebranded to ADTEC Code to better reflect its identity.
- **Custom Modes:** Introduced the ability to create custom personas for ADTEC Code, define custom prompts, choose tool access for each mode, and create specialized assistants. Users can get started via the Prompts tab or by typing "Create a new mode for ".
