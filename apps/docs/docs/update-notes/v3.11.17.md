---
description: ADTEC Code 3.11.17 improves OpenAI cache reporting, enhances auto-approve toggles UI, and fixes diff logic and terminal race conditions.
keywords:
    - ADTEC Code
    - v3.11.17
    - release notes
...
# ADTEC Code 3.11.17 Release Notes (2025-04-14)
...
- Improvements to OpenAI cache reporting and cost estimates (thanks monotykamary and ADTEC Code!)
