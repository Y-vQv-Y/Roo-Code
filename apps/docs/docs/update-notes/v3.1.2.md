---
description: ADTEC Code 3.1.2 adds experimental VS Code Language Models support including Copilot, improves fuzzy search, and fixes configuration bugs.
keywords:
    - ADTEC Code
    - v3.1.2
    - copilot support
...
# ADTEC Code 3.1.2 Release Notes
