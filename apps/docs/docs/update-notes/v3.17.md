---
description: ADTEC Code 3.17 combines all v3.17.x updates including Intelligent Context Condensation, Boomerang improvements, and various bug fixes.
keywords:
    - ADTEC Code
    - v3.17
    - release notes
...
# ADTEC Code 3.17 Release Notes (2025-05-14)
...
We've made several under-the-hood refinements to improve how ADTEC Code understands and responds to your requests:
...
- **Automatic Summarization:** When a conversation approaches its context window limit (specifically, when the context window is almost full), ADTEC Code now automatically uses a Large Language Model (LLM) to summarize the existing conversation history.
...
## Smoother Chat and Fewer Interruptions! (thanks ADTEC Code!)

We've made a couple of nice tweaks to make your ADTEC Code experience even better:

- **Keep Typing, Even When ADTEC Code's Thinking:** You can now type your next message in the chat even while ADTEC Code is busy processing your current request. No more waiting for the input field to unlock – just keep your thoughts flowing!
- **Stay Focused When Viewing Changes:** We've improved how ADTEC Code handles your cursor focus when showing you code differences. This means fewer interruptions to your workflow when ADTEC Code presents changes for review.

These improvements aim to make your interactions with ADTEC Code feel more fluid and less disruptive.
...
- **Faster Message Parsing**: We've switched to a more performant way of processing messages. (thanks ADTEC Code!)
...
- **Improved Developer Experience for Integrations**: We've added better support for developers building tools that interact with ADTEC Code.
