---
description: ADTEC Code 3.7.9 improves context window management, fixes terminal output parsing, adds Claude Sonnet 3.7 thinking support, and enhances UI elements.
keywords:
    - ADTEC Code 3.7.9
    - context management
    - terminal parsing
...
# ADTEC Code 3.7.9 Release Notes (2025-03-01)
