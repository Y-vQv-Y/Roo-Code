---
description: ADTEC Code 3.2.8 fixes custom modes settings, improves API key entry validation, adds Azure checkbox for OpenAI, and updates Bedrock models.
keywords:
    - ADTEC Code
    - v3.2.8
...
# ADTEC Code 3.2.8 Release Notes
