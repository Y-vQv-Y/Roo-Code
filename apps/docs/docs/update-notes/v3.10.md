---
description: ADTEC Code 3.10 introduces chunked large file reading, suggested responses, improved @-mentions, dynamic instructions, Gemini 2.5 Pro support, and numerous fixes.
keywords:
    - ADTEC Code 3.10
    - context management
    - large files
...
# ADTEC Code 3.10 Release Notes (2025-03-25)
...
- **Reading Large Files in Chunks:** ADTEC Code can now read large files in chunks, allowing for more efficient processing and context utilization. (thanks samhvw8!)
- **Suggested Responses to Questions:** When ADTEC Code asks a question, it now provides suggested responses to streamline user interaction. (thanks samhvw8!)
