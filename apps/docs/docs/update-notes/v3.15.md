---
description: ADTEC Code 3.15 adds Google Vertex prompt caching, terminal command fallback, enhanced Boomerang mode, and settings import/export.
keywords:
    - ADTEC Code
    - v3.15
    - release notes
...
# ADTEC Code 3.15 Release Notes (2025-05-05)
...
- ADTEC Code settings can now be imported directly from the welcome screen (thanks julionav).
...
- Simplified and streamlined ADTEC Code's [quick actions](/features/code-actions).
