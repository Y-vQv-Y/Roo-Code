---
description: ADTEC Code 3.3.13 ensures DeepSeek R1 works with Ollama, enables terminal context menus, improves sliding window truncation, and fixes API profile switching bugs.
keywords:
    - ADTEC Code 3.3.13
    - deepseek r1
    - ollama
...
# ADTEC Code 3.3.13 Release Notes
...
- Enabled context menu commands (like copy/paste) within the integrated terminal used by ADTEC Code. (thanks samhvw8!)
