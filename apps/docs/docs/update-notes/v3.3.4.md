---
description: ADTEC Code 3.3.4 delivers up to 10x faster diff editing performance, configurable MCP server timeouts, and enhanced code actions with context menu integration.
keywords:
    - ADTEC Code 3.3.4
    - diff editing
...
# ADTEC Code 3.3.4 Release Notes
