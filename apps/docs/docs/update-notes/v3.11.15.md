---
description: ADTEC Code 3.11.15 adds workspace-based task history filtering, package.json localization, and Anthropic Authorization header support.
keywords:
    - ADTEC Code
    - v3.11.15
    - release notes
...
# ADTEC Code 3.11.15 Release Notes (2025-04-13)
