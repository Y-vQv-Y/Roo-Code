---
description: ADTEC Code 3.16.5 reverts provider profile management changes to fix a bug with defaults, ensuring stable API configuration.
keywords:
    - ADTEC Code
    - v3.16.5
    - release notes
...
# ADTEC Code 3.16.5 Release Notes (2025-05-10)
