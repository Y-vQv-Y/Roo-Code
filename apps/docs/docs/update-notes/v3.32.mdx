---
description: Combined notes for ADTEC Code 3.32, including GPT-5.1 model support, OpenAI Responses prompt caching, and reliability fixes for OpenAI Native and native tools.
keywords:
  - ADTEC Code 3.32
  - release notes
  - gpt-5.1
...
# ADTEC Code 3.32 Release Notes (2025-11-14)

ADTEC Code 3.32 combines GPT-5.1 model support and OpenAI Responses prompt caching with reliability fixes for OpenAI Native and native tool protocol.

<img src="/img/v3.32.0/v3.32.0.png" alt="ADTEC Code v3.32 Release" width="600" />

## GPT-5.1 models and OpenAI prompt caching

* **GPT-5.1 in ADTEC Code** ([#9252](https://github.com/Y-vQv-Y), [#9258](https://github.com/Y-vQv-Y), [#9261](https://github.com/Y-vQv-Y), [#9259](https://github.com/Y-vQv-Y))
...
* **Share button works reliably again** ([#9253](https://github.com/Y-vQv-Y))
  Fixes the Share button so you can open the share popover and send shared tasks and messages without failures.

* **Keep OpenAI Native reasoning stable during condensing** ([#9263](https://github.com/Y-vQv-Y))
...
* **Prevent duplicate tool_result blocks for read_file in native protocol** ([#9272](https://github.com/Y-vQv-Y))
...
* **Fix duplicate tool blocks causing "tool has already been used" errors** ([#9275](https://github.com/Y-vQv-Y))
...
* **Make OpenAI Native cancellation stop streaming immediately** ([#9276](https://github.com/Y-vQv-Y))
...
* **Disable XML parser for native tool protocol** ([#9277](https://github.com/Y-vQv-Y))
