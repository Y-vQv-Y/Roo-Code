---
description: ADTEC Code 3.11.12 enables Grok3 streaming through OpenAI Compatible providers and makes diff editing more tolerant of model errors.
keywords:
    - ADTEC Code
    - v3.11.12
    - release notes
...
# ADTEC Code 3.11.12 Release Notes (2025-04-09)
