---
description: ADTEC Code 3.12.3 adds drag-and-drop tabs to chat, fixes Gemini character escaping, and ensures slash commands work correctly.
keywords:
    - ADTEC Code
    - v3.12.3
    - release notes
...
# ADTEC Code 3.12.3 Release Notes (2025-04-17)
