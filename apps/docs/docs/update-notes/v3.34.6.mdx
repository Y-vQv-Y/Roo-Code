...
# ADTEC Code 3.34.6 Release Notes (2025-11-26)
...
<img src="/img/v3.34.6/v3.34.6.png" alt="ADTEC Code v3.34.6 Release" width="600" />

## Features

* **AWS Bedrock embeddings for code indexing**: Adds support for using AWS Bedrock embeddings in code indexing so teams that standardize on Bedrock can reuse their existing infrastructure when indexing repos for ADTEC Code-based navigation and search (PR #9475).
