---
description: ADTEC Code 3.14.2 introduces Gemini prompt caching for faster responses, terminal improvements, and adds Russian language support.
keywords:
    - ADTEC Code
    - v3.14.2
    - release notes
...
# ADTEC Code 3.14.2 Release Notes (2025-04-24)
