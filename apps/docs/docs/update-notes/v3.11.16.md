---
description: ADTEC Code 3.11.16 adds gpt-4.1, gpt-4.1-mini, and gpt-4.1-nano models to OpenAI provider and includes model ID in task details.
keywords:
    - ADTEC Code
    - v3.11.16
    - release notes
...
# ADTEC Code 3.11.16 Release Notes (2025-04-14)
