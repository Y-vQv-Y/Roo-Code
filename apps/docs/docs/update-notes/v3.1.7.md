---
description: ADTEC Code 3.1.7 adds support for DeepSeek-R1 models, introduces experimental unified diff algorithm, and fixes API configuration profiles.
keywords:
    - ADTEC Code
    - v3.1.7
    - deepseek-r1
...
# ADTEC Code 3.1.7 Release Notes
