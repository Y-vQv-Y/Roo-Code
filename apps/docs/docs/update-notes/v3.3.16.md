---
description: ADTEC Code 3.3.16 fixes API configuration jumpiness, adds checkpoint tooltips, resolves git settings issues, and adds support for Volcano Ark platform.
keywords:
    - ADTEC Code 3.3.16
    - checkpoints
    - api configuration
...
# ADTEC Code 3.3.16 Release Notes (2025-02-09)
