---
description: ADTEC Code 3.13.0 adds Gemini 2.5 Flash Preview, new append_to_file tool, UI improvements, and fixes for Bedrock image support.
keywords:
    - ADTEC Code
    - v3.13.0
    - release notes
...
# ADTEC Code 3.13.0 Release Notes (2025-04-17)
