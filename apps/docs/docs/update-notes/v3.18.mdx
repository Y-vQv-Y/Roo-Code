---
description: ADTEC Code 3.18 introduces experimental codebase indexing, enhanced context condensing, YAML support for custom modes, and Gemini 2.5 Flash support.
keywords:
  - ADTEC Code 3.18
  - release notes
  - codebase indexing
...
# ADTEC Code 3.18 Release Notes (2025-05-21)
...
Custom mode configuration is now significantly improved with **YAML support** for both global and project-level (`.adtecmodes`) definitions. YAML is the new default, offering superior readability with cleaner syntax, support for comments (`#`), and easier multi-line string management. While JSON remains supported for backward compatibility, YAML streamlines mode creation, sharing, and version control.
...
To enhance API cost management, you can now set a **Max Requests** limit for auto-approved actions. This prevents ADTEC Code from making an excessive number of consecutive API calls without your re-approval.

<img src="/img/v3.18.0/v3.18.0.png" alt="Setting the Max Requests limit for auto-approved actions in ADTEC Code settings." width="600" />
...
Learn more about configuring this safeguard in our [Rate Limits and Costs documentation](/advanced-usage/rate-limits-costs#limiting-auto-approved-requests). (Inspired by ADTEC Code, thanks hassoncs!)
...
*   **Automated Nightly Builds**: Created automated [nightly release system](/advanced-usage/adtec-code-nightly) to deliver the latest features and fixes more quickly
