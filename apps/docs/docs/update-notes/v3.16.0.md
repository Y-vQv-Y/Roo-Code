---
description: ADTEC Code 3.16.0 introduces vertical tab navigation for settings, Groq and Chutes AI providers, clickable code references, and UI/UX enhancements.
keywords:
    - ADTEC Code
    - v3.16.0
    - release notes
...
# ADTEC Code 3.16.0 Release Notes

_Release notes for ADTEC Code v3.16.0, published on 2025-05-06._
