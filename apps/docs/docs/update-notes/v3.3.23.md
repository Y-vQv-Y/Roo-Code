---
description: ADTEC Code 3.3.23 patch release fixes issues with unsaved changes on settings page and improves error handling when reading custom instructions from files.
keywords:
    - ADTEC Code 3.3.23
    - settings management
    - unsaved changes
...
# ADTEC Code 3.3.23 Release Notes (2025-02-20)
