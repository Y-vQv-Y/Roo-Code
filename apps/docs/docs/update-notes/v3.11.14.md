---
description: ADTEC Code 3.11.14 adds support for symbolic links in rules folders and enforces full file reading settings for better reliability.
keywords:
    - ADTEC Code
    - v3.11.14
    - release notes
...
# ADTEC Code 3.11.14 Release Notes (2025-04-11)
