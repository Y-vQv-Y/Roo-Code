---
description: ADTEC Code 3.3.15 introduces experimental Checkpoints for tracking project changes, adds copy button to recent tasks, enhances API profile flow, and fixes MCP initialization.
keywords:
    - ADTEC Code 3.3.15
    - checkpoints
...
# ADTEC Code 3.3.15 Release Notes (2025-02-08)
