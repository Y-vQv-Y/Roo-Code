---
description: ADTEC Code 3.7.7 graduates Checkpoints out of beta, enabling automatic project change tracking by default, plus fixes for Enhance Prompt and UI tooltips.
keywords:
    - ADTEC Code 3.7.7
    - checkpoints feature
    - project tracking
...
# ADTEC Code 3.7.7 Release Notes (2025-02-27)
