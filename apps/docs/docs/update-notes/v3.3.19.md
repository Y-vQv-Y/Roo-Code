---
description: ADTEC Code 3.3.19 fixes file write abort reverting, honors VS Code themes in dialogs, allows clearing default custom instructions, and uses shadow git for checkpoints.
keywords:
    - ADTEC Code 3.3.19
    - file write abort
    - vs code theme
...
# ADTEC Code 3.3.19 Release Notes (2025-02-12)
...
- Switched checkpoints logic to use a shadow git repository to avoid issues with hot reloads and polluting existing repositories. (thanks ADTEC Code!)
