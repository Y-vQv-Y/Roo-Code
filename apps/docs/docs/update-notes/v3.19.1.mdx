...
# ADTEC Code 3.19.1 Release Notes (2025-05-31)
...
This experimental feature transforms how ADTEC Code understands and works with your entire codebase at once (thanks samhvw8!).
...
Enterprise customers can now use ADTEC Code with AWS Bedrock while maintaining complete network security (thanks kcwhite!). See the [AWS Bedrock configuration guide](/providers/bedrock#configuration-in-adtec-code) for setup instructions.
