---
description: ADTEC Code 2.2 introduces MCP support for custom tools, API configuration profiles, enhanced diff editing, and numerous quality-of-life improvements.
keywords:
    - ADTEC Code
    - v2.2
    - mcp support
...
# ADTEC Code 2.2 Release Notes (2025-02-27)
...
- **Model Context Protocol (MCP) Support (v2.2.0):**
    - Added support for MCP, enabling ADTEC Code to use custom tools like web search or GitHub tools.
    - Added an MCP server management tab.
    - Enabled ADTEC Code to dynamically create new MCP servers based on user requests.
...
- **ADTEC Code ADTEC Code Runs in All VSCode-Compatible Editors (v2.1.6).**
- **ADTEC Code ADTEC Code Side-by-Side with ADTEC Code (v2.1.4).**
