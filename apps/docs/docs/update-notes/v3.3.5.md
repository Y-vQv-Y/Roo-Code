---
description: ADTEC Code 3.3.5 adds context window token visibility, auto-approve mode switching, experimental insert_content and search_and_replace tools, plus DeepSeek R1 improvements.
keywords:
    - ADTEC Code 3.3.5
    - context window
    - token count
...
# ADTEC Code 3.3.5 Release Notes
