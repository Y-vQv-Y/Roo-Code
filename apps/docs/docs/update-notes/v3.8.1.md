---
description: ADTEC Code 3.8.1 improves context window visualization, configuration profile UI, and fixes bugs with custom temperature, decimal prices, and enhance prompt features.
keywords:
    - ADTEC Code 3.8.1
    - context window
...
# ADTEC Code 3.8.1 Release Notes (2025-03-07)
