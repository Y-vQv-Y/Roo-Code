---
description: ADTEC Code 3.7 introduces Claude Sonnet 3.7 support, expanded thinking models with 128k tokens, Mermaid diagrams, keyboard shortcuts, and numerous improvements.
keywords:
    - ADTEC Code 3.7
    - claude sonnet 3.7
    - thinking models
...
# ADTEC Code 3.7 Release Notes (2025-03-03)

This release cycle introduces ADTEC Code 3.7 with Claude Sonnet 3.7 support, expanded model capabilities (including "Thinking" Sonnet and increased token limits), Vertex AI enhancements, improved context window management, UI refinements like Mermaid diagrams and drag-and-drop, and numerous bug fixes.
...
- **Mermaid Diagram Support:** Added support for rendering Mermaid diagrams in chat. (thanks ADTEC Code!)
