...
# ADTEC Code 3.19.0 Release Notes (2025-05-30)
...
*   **Enhanced Sidebar Compatibility**: Menu functionality now remains stable when moving ADTEC Code between primary and secondary sidebars (thanks chrarnoldus!)

---

## Bug Fixes

*   **Directory Mention Protection**: Fixed [`@directory`](/basic-usage/context-mentions) not respecting [`.adtecignore`](/features/adtecignore) files (thanks xyOz-dev!)
*   **Tool File Protection**: Added [`adtecignore`](/features/adtecignore) checking for `insert_content` and `search_and_replace` tools
