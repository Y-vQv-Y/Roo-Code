---
description: ADTEC Code 3.11.10 fixes nested .adtec/rules directories, OpenAI provider caching, and improves command output handling and translations.
keywords:
    - ADTEC Code
    - v3.11.10
    - release notes
...
# ADTEC Code 3.11.10 Release Notes (2025-04-08)
...
- Fixed bug where nested `.adtec/rules` directories are not respected properly (thanks @taisukeoe!).
