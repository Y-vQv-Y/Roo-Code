---
description: ADTEC Code 3.32.0 adds GPT-5.1 models, enables OpenAI Responses prompt caching, fixes the share button, and improves release-note traceability.
keywords:
  - ADTEC Code 3.32.0
  - gpt-5.1
...
# ADTEC Code 3.32.0 Release Notes (2025-11-14)
...
<img src="/img/v3.32.0/v3.32.0.png" alt="ADTEC Code v3.32.0 Release" width="600" />

## Features & Improvements

* **GPT-5.1 in ADTEC Code** ([#9252](https://github.com/Y-vQv-Y), [#9258](https://github.com/Y-vQv-Y), [#9261](https://github.com/Y-vQv-Y), [#9259](https://github.com/Y-vQv-Y)): Adds all new GPT-5.1 models to the OpenAI Native provider with extended 24‑hour prompt caching support, all new GPT-5.1 models and overall support for 51 throughout other supported providers.
...
- **Share button works reliably again**: Fixes the Share button so you can open the share popover and send shared tasks and messages without failures ([#9253](https://github.com/Y-vQv-Y)).

### Misc

- **Release notes are easier to audit**: The internal release guide now requires PR numbers in release notes so each documented change can be traced back to its source PR ([#9236](https://github.com/Y-vQv-Y)).