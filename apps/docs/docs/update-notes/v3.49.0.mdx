---
description: ADTEC Code 3.49.0 adds a file changes panel per conversation, per-workspace codebase indexing control, and fixes chat scroll and multi-window history reliability.
keywords:
  - ADTEC Code 3.49.0
  - file changes panel
...
# ADTEC Code 3.49.0 Release Notes (2026-02-19)
