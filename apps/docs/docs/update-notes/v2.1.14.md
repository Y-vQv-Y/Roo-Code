---
description: ADTEC Code 2.1.14 fixes diff application bugs, adds unified diff prompts, and auto-rejects truncated outputs for more reliable diff editing.
keywords:
    - ADTEC Code 2.1.14
    - diff editing fixes
    - unified diff
...
# ADTEC Code 2.1.14 Release Notes
