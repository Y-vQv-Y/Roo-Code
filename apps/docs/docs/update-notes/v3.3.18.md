---
description: ADTEC Code 3.3.18 adds per-API temperature settings for model creativity control, Requesty provider support, copy button for system prompts, and Windows checkpoint fixes.
keywords:
    - ADTEC Code 3.3.18
    - temperature control
    - requesty provider
...
# ADTEC Code 3.3.18 Release Notes (2025-02-11)
