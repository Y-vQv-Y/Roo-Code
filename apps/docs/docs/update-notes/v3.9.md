---
description: ADTEC Code v3.9 enhances usability by allowing concurrent file reads for faster context gathering, improving diff view readability, and refining UI elements for a smoother user experience.
---

# ADTEC Code 3.9 Release Notes (2025-03-19)
...
- **Broad Language Support:** ADTEC Code has been internationalized into Catalan, German, Spanish, French, Hindi, Italian, Japanese, Korean, Polish, Portuguese, Turkish, Vietnamese, Simplified Chinese, and Traditional Chinese. (thanks @feifei325!)
- **Text-to-Speech:** Added an option to have ADTEC Code talk to you as it works, including persisting the speed state. (thanks @heyseth!)
...
- **Task History Saving (Multiple ADTEC Code):** Fixed task history saving when running multiple instances of ADTEC Code. (thanks @samhvw8!)
...
- **Wheel Scrolling in Editor Tabs:** Fixed wheel scrolling when ADTEC Code is opened in editor tabs. (thanks @GitlyHallows!)
