---
title: "ADTEC Code v3.34.8 Release Notes"
description: "ADTEC Code v3.34.8 fixes a race condition in the new_task tool for native protocol APIs."
keywords:
  - ADTEC Code 3.34.8
  - bug fixes
  - new_task tool
...
# ADTEC Code 3.34.8 Release Notes (2025-11-27)

This release fixes a race condition affecting subtask handling in native protocol APIs.

<img src="/img/v3.34.8/v3.34.8.png" alt="ADTEC Code v3.34.8 Release" width="600" />
