---
description: ADTEC Code 3.15.5 updates Google GenAI to v0.12 for streaming fixes and improves code block rendering performance in chat.
keywords:
    - ADTEC Code
    - v3.15.5
    - release notes
...
# ADTEC Code 3.15.5 Release Notes (2025-05-05)
