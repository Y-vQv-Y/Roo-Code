---
description: ADTEC Code 3.17.1 fixes command display during approval and corrects token calculation on OpenRouter for accurate cost tracking.
keywords:
    - ADTEC Code
    - v3.17.1
    - release notes
...
# ADTEC Code 3.17.1 Release Notes (2025-05-15)
