---
description: ADTEC Code 3.15.2 enhances Boomerang Orchestrator for secure task automation, improves Mermaid rendering, and adds OpenAI custom URLs.
keywords:
    - ADTEC Code
    - v3.15.2
    - release notes
...
# ADTEC Code 3.15.2 Release Notes (2025-05-02)
...
- **Fixed Chat Input Height Instability**
    - Resolved an issue where the chat input box height could jump unexpectedly when resizing the ADTEC Code window.
