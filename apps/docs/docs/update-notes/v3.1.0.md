---
description: ADTEC Code 3.1.0 enables customization of chat mode prompts and instructions, revamps Enhance Prompt feature, and adds Markdown copy functionality.
keywords:
    - ADTEC Code
    - v3.1.0
...
# ADTEC Code 3.1.0 Release Notes
