---
description: ADTEC Code 3.3.22 adds MCP server deletion, wildcard command auto-approval, enhanced provider settings UI, custom language preferences, Catalan support, and Ollama reasoning tags.
keywords:
    - ADTEC Code 3.3.22
    - mcp server delete
...
# ADTEC Code 3.3.22 Release Notes (2025-02-20)
...
- Fixed the `.adtecmodes` file not being automatically created when adding custom modes from the Prompts tab.
