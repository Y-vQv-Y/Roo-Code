---
description: ADTEC Code 3.2.5 adds the gemini-flash-thinking-01-21 model and includes minor visual fixes for improved user interface consistency.
keywords:
    - ADTEC Code
    - v3.2.5
...
# ADTEC Code 3.2.5 Release Notes
