---
description: ADTEC Code 3.10.4 adds Gemini 2.5 Pro, R1 support for QWQ models, Bedrock application-inference-profile, improved UI/UX, and dynamic mode instructions fetching.
keywords:
    - ADTEC Code 3.10.4
    - gemini 2.5 pro
    - r1 support
...
# ADTEC Code 3.10.4 Release Notes (2025-03-25)
...
- Added `taskCreated` event to API and subscribed to ADTEC Code events earlier. (thanks wkordalski!)
