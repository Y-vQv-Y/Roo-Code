---
description: ADTEC Code 3.1 brings customizable chat mode prompts, DeepSeek-R1 support, Mistral provider, auto-approve chat bar, and numerous improvements.
keywords:
    - ADTEC Code
    - v3.1
    - customizable modes
...
# ADTEC Code 3.1 Release Notes (2025-02-27)
...
- **Auto-Approve Chat Bar (v3.1.3):** Added an auto-approve chat bar for quicker interactions. (thanks ADTEC Code!)
...
- **Mistral Provider (v3.1.6):** Integrated the Mistral provider. (thanks ADTEC Code!)
...
- **Updated VSCode Engine Requirement (v3.0.3):** Updated the required VSCode engine to `^1.84.0` to match ADTEC Code.
