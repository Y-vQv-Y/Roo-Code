---
description: ADTEC Code 2.1 introduces diff editing, OpenRouter compression, sound effects, VSCode compatibility, and side-by-side ADTEC Code support.
keywords:
    - ADTEC Code 2.1
    - major release
    - diff editing
...
# ADTEC Code 2.1 Release Notes (2025-02-27)

This release cycle, prior to the introduction of MCP and major version 2.2, focused on foundational improvements including experimental diff editing, OpenRouter compression, sound effects, and making ADTEC Code ADTEC Code (now ADTEC Code) work in all VSCode-compatible editors and side-by-side with the original ADTEC Code.
...
- **Runs in All VSCode-Compatible Editors (v2.1.6):** ADTEC Code ADTEC Code (now ADTEC Code) was updated to run in all VSCode-compatible editors.
- **Side-by-Side with ADTEC Code (v2.1.4):** Enabled ADTEC Code ADTEC Code (now ADTEC Code) to run side-by-side with the original ADTEC Code extension.
