---
description: ADTEC Code 3.0.0 introduces Chat Modes (Code, Architect, Ask), allowing tailored interactions for coding, system design, and general questions.
keywords:
    - ADTEC Code
    - v3.0.0
    - chat modes
...
# ADTEC Code 3.0.0 Release Notes
