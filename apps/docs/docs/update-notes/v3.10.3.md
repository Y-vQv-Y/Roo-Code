---
description: ADTEC Code 3.10.3 enhances partial file reads with explicit full file requests, custom chunk sizes, and fixes for multi-block diff, binary files, and OpenRouter pricing.
keywords:
    - ADTEC Code 3.10.3
    - large file handling
    - partial file reads
...
# ADTEC Code 3.10.3 Release Notes (2025-03-23)
