---
description: ADTEC Code 2.2.23 corrects context window size information for gemini-2.0-flash-thinking-exp-1219 model for accurate usage.
keywords:
    - ADTEC Code
    - v2.2.23
    - release notes
...
# ADTEC Code 2.2.23 Release Notes
