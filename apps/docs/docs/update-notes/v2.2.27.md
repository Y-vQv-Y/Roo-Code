---
description: ADTEC Code 2.2.27 adds current time to system prompts and enhances browser screenshot quality for improved functionality.
keywords:
    - ADTEC Code
    - v2.2.27
    - release notes
...
# ADTEC Code 2.2.27 Release Notes
