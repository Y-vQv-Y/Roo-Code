---
description: ADTEC Code 3.3.0 introduces native VS Code actions, intelligent mode switching, enhanced Markdown support, and AWS profile configuration for Bedrock provider.
keywords:
    - ADTEC Code 3.3.0
    - code actions
    - mode switching
...
# ADTEC Code 3.3.0 Release Notes
