---
description: ADTEC Code 3.3.3 patch release enhances error handling for restricted file writes and improves mode/configuration dropdown styling.
keywords:
    - ADTEC Code 3.3.3
    - error handling
    - ui styling
...
# ADTEC Code 3.3.3 Release Notes
