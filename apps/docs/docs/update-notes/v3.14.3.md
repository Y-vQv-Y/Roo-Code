---
description: ADTEC Code 3.14.3 adds Boomerang Orchestrator as default mode, features a new minimalist home screen, and improves token estimation.
keywords:
    - ADTEC Code
    - v3.14.3
    - release notes
...
# ADTEC Code 3.14.3 Release Notes (2025-04-25)
