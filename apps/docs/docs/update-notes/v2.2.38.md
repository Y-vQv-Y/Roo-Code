---
description: ADTEC Code 2.2.38 adds configurable terminal output lines passed to models, optimizing context usage for command execution.
keywords:
    - ADTEC Code
    - v2.2.38
    - release notes
...
# ADTEC Code 2.2.38 Release Notes
