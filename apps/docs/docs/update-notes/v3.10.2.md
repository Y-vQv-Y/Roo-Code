---
description: ADTEC Code 3.10.2 fixes context mentions on Windows, corrects German translations, resolves i18n telemetry issues, and ensures proper token limits for Sonnet 3.7.
keywords:
    - ADTEC Code 3.10.2
    - context mentions
    - windows fix
...
# ADTEC Code 3.10.2 Release Notes (2025-03-21)
