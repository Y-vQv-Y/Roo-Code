---
description: ADTEC Code 3.11.3 reverts recent context mention changes to address potential performance issues and crashes, prioritizing stability while investigating root causes.
keywords:
    - ADTEC Code 3.11.3
    - context mentions
    - stability fix
...
# ADTEC Code 3.11.3 Release Notes (2025-03-31)
