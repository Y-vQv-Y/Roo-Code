---
description: ADTEC Code 3.3.1 patch release fixes terminal management issues and mode switching bugs for improved stability and performance.
keywords:
    - ADTEC Code 3.3.1
    - terminal management
    - mode switching
...
# ADTEC Code 3.3.1 Release Notes
