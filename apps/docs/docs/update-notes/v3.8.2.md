---
description: ADTEC Code 3.8.2 adds auto-approval toggle for Boomerang Tasks, progress indicators for multi-diff editing, o3-mini support, and fixes encoding issues.
keywords:
    - ADTEC Code 3.8.2
    - auto-approval
    - boomerang tasks
...
# ADTEC Code 3.8.2 Release Notes (2025-03-08)
