---
description: ADTEC Code 3.11.5 adds prompt caching for Amazon Bedrock, configurable MCP server working directories, API profile management, and improved diff editing.
keywords:
    - ADTEC Code 3.11.5
...
# ADTEC Code 3.11.5 Release Notes (2025-04-03)
