---
description: ADTEC Code 3.16.1 adds LiteLLM provider support, tool loop detection for improved stability, Dutch localization, and various UI improvements.
keywords:
    - ADTEC Code
    - v3.16.1
    - release notes
...
# ADTEC Code 3.16.1 Release Notes (2025-05-07)
...
- **Automatic Model Discovery**: ADTEC Code automatically fetches and lists available models from your LiteLLM server. This means users no longer need to manually configure each LiteLLM model within ADTEC Code, streamlining setup and making it easier to switch between models served by LiteLLM.
