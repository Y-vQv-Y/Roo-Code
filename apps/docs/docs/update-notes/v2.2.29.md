---
description: ADTEC Code 2.2.29 adds configurable delay after auto-approved file writes, allowing diagnostics and linters time to process.
keywords:
    - ADTEC Code
    - v2.2.29
    - release notes
...
# ADTEC Code 2.2.29 Release Notes
