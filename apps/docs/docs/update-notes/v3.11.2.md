---
description: ADTEC Code 3.11.2 fixes Requesty API key balance loading, resolves Bedrock inference profile issues, and improves webview message handling for better stability.
keywords:
    - ADTEC Code 3.11.2
    - requesty api
    - bedrock inference
...
# ADTEC Code 3.11.2 Release Notes (2025-03-31)
