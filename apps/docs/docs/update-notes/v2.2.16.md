---
description: ADTEC Code 2.2.16 adds support for Amazon Titan and Meta Llama models (3, 3.1, 3.2) via AWS Bedrock with unified API calls.
keywords:
    - ADTEC Code 2.2.16
    - aws bedrock
    - amazon titan
...
# ADTEC Code 2.2.16 Release Notes
