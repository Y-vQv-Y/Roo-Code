---
description: ADTEC Code 3.7.12 expands thinking model capabilities to 128k tokens, improves context management with Anthropic count_tokens API, and adds browser tool controls.
keywords:
    - ADTEC Code 3.7.12
    - thinking models
    - 128k tokens
...
# ADTEC Code 3.7.12 Release Notes (2025-03-03)
