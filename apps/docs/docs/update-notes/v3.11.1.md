---
description: ADTEC Code 3.11.1 relaxes JSON schema validation for provider profiles, allowing greater flexibility for custom setups and reducing validation errors.
keywords:
    - ADTEC Code 3.11.1
    - provider profiles
    - json schema
...
# ADTEC Code 3.11.1 Release Notes (2025-03-30)
