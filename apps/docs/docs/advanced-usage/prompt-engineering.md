---
description: Master the art of writing effective prompts for ADTEC Code. Learn principles, techniques, and examples to get better AI coding assistance results.
keywords:
    - prompt engineering
    - AI prompts
...
Prompt engineering is the art of crafting effective instructions for AI models like ADTEC Code. Well-written prompts lead to better results, fewer errors, and a more efficient workflow.

---

## General Principles

- **Be Clear and Specific:** Clearly state what you want ADTEC Code to do. Avoid ambiguity.
...
It's often helpful to guide ADTEC Code through a "think-then-do" process:

1.  **Analyze:** Ask ADTEC Code to analyze the current code, identify problems, or plan the approach.
2.  **Plan:** Have ADTEC Code outline the steps it will take to complete the task.
3.  **Execute:** Instruct ADTEC Code to implement the plan, one step at a time.
...
You can provide custom instructions to further tailor ADTEC Code's behavior. There are two types of custom instructions:
...
- Adjust ADTEC Code's tone or personality.
...
If your request is ambiguous or lacks sufficient detail, ADTEC Code might:
...
If ADTEC Code doesn't produce the desired results, you can provide feedback by:

- **Rejecting Actions:** Click the "Reject" button when ADTEC Code proposes an action you don't want.
- **Providing Explanations:** When rejecting, explain _why_ you're rejecting the action. This helps ADTEC Code learn from its mistakes.
...
By following these tips, you can write effective prompts that get the most out of ADTEC Code's capabilities.
