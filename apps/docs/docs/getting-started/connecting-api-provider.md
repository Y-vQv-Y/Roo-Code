...
description: Learn how to connect ADTEC Code to AI providers like Anthropic Claude, OpenAI, and OpenRouter. Step-by-step guide for API key setup and configuration.
keywords:
    - ADTEC Code API key
    - Claude API
    - OpenAI API
...
ADTEC Code needs an inference provider to access the LLM models that make it work.
...
ADTEC Code is compatible with [other providers](/providers) which offer Claude, and with a wide range of different models you can try.
