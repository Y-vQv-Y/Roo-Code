/**
 * Theme configuration for ADTEC Code CLI TUI
...
export const adtecHeader = hardcore.yellow // Yellow for adtec-code
...
export const adtecText = hardcore.text // Standard text for adtec-code
