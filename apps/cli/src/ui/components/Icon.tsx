 ...
 *
 * Users can override this with the ADTEC_CODE_NERD_FONT environment variable:
 * - ADTEC_CODE_NERD_FONT=0 to force ASCII fallbacks (if icons don't render correctly)
 * - ADTEC_CODE_NERD_FONT=1 to force Nerd Font icons
 *
...
function detectNerdFontSupport(): boolean {
	...
	const envOverride = process.env.ADTEC_CODE_NERD_FONT
	...
	// and users can set ADTEC_CODE_NERD_FONT=0 if needed
	return true
}
