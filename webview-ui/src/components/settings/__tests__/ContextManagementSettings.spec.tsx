...
describe("ContextManagementSettings", () => {
	...
	it("renders other context management settings", () => {
		...
		expect(screen.getByTestId("show-adtecignored-files-checkbox")).toBeInTheDocument()
	...
	describe("Accessibility", () => {
		it("has proper labels and descriptions", () => {
			...
			expect(screen.getByText("settings:contextManagement.adtecignore.label")).toBeInTheDocument()
			...
			expect(screen.getByText("settings:contextManagement.adtecignore.description")).toBeInTheDocument()
		})
