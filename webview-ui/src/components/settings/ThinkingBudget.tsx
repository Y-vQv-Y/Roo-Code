...
export const ThinkingBudget = ({ apiConfiguration, setApiConfigurationField, modelInfo }: ThinkingBudgetProps) => {
	...
	// Providers with native thinking enabled by default (for example DeepSeek V4
	// and Kimi K2.6) should show the toggle as enabled before the first save.
	const enableReasoningEffort =
		apiConfiguration.enableReasoningEffort ?? (isReasoningSupported && modelInfo?.preserveReasoning === true)
