...
import AdtecHero from "@src/components/welcome/AdtecHero"
import AdtecTips from "@src/components/welcome/AdtecTips"
				...
				<div className="flex flex-col h-full justify-center p-6 min-h-0 overflow-y-auto gap-4 relative">
					<div className="flex flex-col items-start gap-2 justify-center h-full min-[400px]:px-6">
						...
						<div className="flex flex-col gap-4 w-full">
							<AdtecHero />
							{/* Show AdtecTips when authenticated or when user is new */}
							{taskHistory.length < 6 && <AdtecTips />}
