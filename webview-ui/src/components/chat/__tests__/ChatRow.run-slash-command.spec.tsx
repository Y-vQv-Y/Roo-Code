	...
	useTranslation: () => ({
		t: (key: string) => {
			const translations: Record<string, string> = {
				"chat:slashCommand.wantsToRun": "ADTEC Code wants to run slash command:",
				"chat:slashCommand.didRun": "ADTEC Code ran slash command:",
			}
...
describe("ChatRow - runSlashCommand tool", () => {
	...
	it("should display runSlashCommand ask message with command only", () => {
		...
		expect(getByText("ADTEC Code wants to run slash command:")).toBeInTheDocument()
	...
	it("should display runSlashCommand say message", () => {
		...
		expect(getByText("ADTEC Code ran slash command:")).toBeInTheDocument()
